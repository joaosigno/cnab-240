package richard.cnab240.modelo.registro.header;

import richard.cnab240.modelo.enums.TipoRegistro;
import richard.cnab240.modelo.pojo.Arquivo;
 ...
 *
 */
@richard.cnab240.modelo.anotacao.Registro(obrigatorio=true, tipoRegistro=TipoRegistro.HEADER_DE_ARQUIVO)
