...
import richard.cnab240.modelo.enums.EspecieTitulo;
import richard.cnab240.modelo.enums.TipoRegistro;
import richard.cnab240.modelo.pojo.Agencia;
import richard.cnab240.modelo.pojo.CaracteristicaCobranca;
import richard.cnab240.modelo.pojo.ContaCorrente;
import richard.cnab240.modelo.pojo.Controle;
import richard.cnab240.modelo.pojo.Desconto;
import richard.cnab240.modelo.pojo.Juros;
...
public class TitulosEmCobrancaSegmentoP extends RegistroDeDetalhe {
	...
	public boolean isTituloAceito() {
		return tituloAceito;
	}

	public void setTituloAceito(boolean tituloAceito) {
	...
	public String getConteudoRegistro() {
		...
		sb.append(ArquivoUtils.getCampoBooleano(isTituloAceito()));
		...
		sb.append(ArquivoUtils.getCampoNumerico(getPrazoDiasParaBaixaOuDevolucao(), 2));
